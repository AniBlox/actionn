      ...
      switch (reaction.emoji.name) {
        ...
        case "⏯":
          ...
          if (queue.playing) {
            ...
            queue.textChannel.send(`${user} ⏸ paused the song. ⏸`).catch(console.error);
          } else {
            queue.playing = !queue.playing;
            queue.connection.dispatcher.resume();
            queue.textChannel.send(`${user} ▶ resumed the song! ▶`).catch(console.error);
          }
          break;
        ...
        case "🔇":
          ...
          if (queue.volume <= 0) {
            ...
            queue.textChannel.send(`{user} 🔊 unmuted the song! 🔊`).catch(console.error);
          } else {
            queue.volume = 0;
            queue.connection.dispatcher.setVolumeLogarithmic(0);
            queue.textChannel.send(`${user} 🔇 muted the song! 🔇`).catch(console.error);
          }
          break;
        ...
        case "🔉":
          ...
          queue.textChannel
            .send(`${user} 🔉 Decreased the volume, volume is now ${queue.volume}% 🔉`)
            .catch(console.error);
          break;
        ...
        case "🔊":
          ...
          queue.connection.dispatcher.setVolumeLogarithmic(queue.volume / 100);
          queue.textChannel
            .send(`${user} 🔊 increased the volume, volume is now ${queue.volume}% 🔊`)
            .catch(console.error);
          break;
